...
const MeetTheTeamPage: React.FC = () => {
  return (
    <div className="bg-navy py-16 sm:py-24 relative overflow-hidden">
      {/* Morphing blobs */}
      <div className="morphing-blob w-[350px] h-[350px] top-40 -right-32 opacity-15" />
      <div className="morphing-blob w-[280px] h-[280px] bottom-60 -left-20 opacity-10" style={{ animationDelay: '-8s' }} />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {TEAM_MEMBERS.map((member, i) => (
            <div key={member.name} style={{ animationDelay: `${i * 0.15}s` }}>
              <TeamMemberCard
                name={member.name}
                title={member.title}
                bio={member.bio}
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <ScrollReveal variant="slide-right">
              <div className="bg-navy-light rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col stat-card">
                ...
                <div className="px-6 pb-6 flex-1">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 bg-accent text-navy font-bold py-2 px-4 rounded-full hover:bg-white transition-colors duration-300 text-sm ripple-container"
                  >
