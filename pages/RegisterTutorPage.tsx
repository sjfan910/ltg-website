...
const RegisterTutorPage: React.FC = () => {
  return (
    <div className="bg-navy py-16 sm:py-24 relative overflow-hidden">
      <div className="morphing-blob w-[350px] h-[350px] top-20 -right-32 opacity-15" style={{ animationDelay: '-12s' }} />
        ...
        <ScrollReveal variant="scale-in">
          <div className="text-center max-w-2xl mx-auto bg-navy-light/50 p-10 rounded-2xl border border-accent/20">
            ...
            <a
              ...
              className="inline-block bg-accent text-navy font-bold py-4 px-12 rounded-full hover:bg-white transition-colors duration-300 text-xl shadow-lg cta-glow ripple-container"
            >
              Apply to be a Tutor
            </a>
          </div>
